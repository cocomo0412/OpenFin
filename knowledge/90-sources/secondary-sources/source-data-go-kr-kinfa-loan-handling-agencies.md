---
{
  "id": "source.data.go.kr.kinfa-loan-handling-agencies",
  "title": "서민금융진흥원 서민대출상품 취급기관 정보 서비스",
  "type": "source",
  "description": "서민대출상품별 기관명, 법인번호, 금융기관주소, 상품명 등 취급기관 정보를 제공하는 API 후보입니다.",
  "basis_year": null,
  "parents": [],
  "children": [],
  "related": [],
  ...
  "url": "https://www.data.go.kr/data/15074508/openapi.do",
  ...
  "urls": {
    "canonical": "https://www.data.go.kr/data/15074508/openapi.do",
    "api": "https://www.data.go.kr/data/15074508/openapi.do",
    "documentation": null
  },
  "access": {
    "method": "api",
  ...
  "search_projection": {
    ...
    "search_facets": {},
    "search_text": "source.data.go.kr.kinfa-loan-handling-agencies 서민금융진흥원 서민대출상품 취급기관 정보 서비스 source 서민대출상품별 기관명, 법인번호, 금융기관주소, 상품명 등 취급기관 정",
    "provenance_shard": "reference",
    "source_ids": []
  },
