---
{
  "id": "source.data.go.kr.kinfa-support-centers",
  "title": "서민금융진흥원 서민금융통합지원센터 현황",
  "type": "source",
  "description": "서민금융통합지원센터와 미소금융 지점의 지역, 지점명, 주소, 전화번호를 제공하는 API 후보입니다.",
  "basis_year": null,
  "parents": [],
  "children": [],
  "related": [],
  ...
  "url": "https://www.data.go.kr/data/15037733/openapi.do",
  ...
  "urls": {
    "canonical": "https://www.data.go.kr/data/15037733/openapi.do",
    "api": "https://www.data.go.kr/data/15037733/openapi.do",
    "documentation": null
  },
  "access": {
    "method": "api",
  ...
  "search_projection": {
    ...
    "search_facets": {},
    "search_text": "source.data.go.kr.kinfa-support-centers 서민금융진흥원 서민금융통합지원센터 현황 source 서민금융통합지원센터와 미소금융 지점의 지역, 지점명, 주소, 전화번호를 제공하는 api 후보",
    "provenance_shard": "reference",
    "source_ids": []
  },
