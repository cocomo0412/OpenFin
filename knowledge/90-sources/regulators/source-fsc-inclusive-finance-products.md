---
{
  "id": "source.fsc.inclusive-finance-products",
  "title": "금융위원회 서민금융상품기본정보",
  "type": "source",
  "description": "서민금융 한눈에 기반의 서민금융 대출상품, 자산형성상품, 사회적 금융 상품 명칭·지원대상·금리·한도·상환방식 API 후보입니다.",
  "basis_year": null,
  "parents": [],
  "children": [],
  "related": [],
  ...
  "urls": {
    "canonical": "https://www.data.go.kr/data/15094787/openapi.do",
    "api": "https://www.data.go.kr/data/15094787/openapi.do",
    "documentation": null
  },
  "access": {
    "method": "api",
  ...
  "search_projection": {
    ...
    "search_facets": {},
    "search_text": "source.fsc.inclusive-finance-products 금융위원회 서민금융상품기본정보 source 서민금융 한눈에 기반의 서민금융 대출상품, 자산형성상품, 사회적 금융 상품 명칭·지원대상·금리·한도·상환",
    "provenance_shard": "reference",
    "source_ids": []
  },
