---
{
  "id": "source.fsc.medical-reimbursement-insurance",
  "title": "금융위원회 실손보험정보",
  "type": "source",
  "description": "생명보험협회 및 손해보험협회에서 제공하는 실손의료보험 유형, 담보, 성별·연령별 기준 보험료 API 후보입니다.",
  "basis_year": null,
  "parents": [],
  "children": [],
  "related": [],
  ...
  "url": "https://www.data.go.kr/data/15094797/openapi.do",
  ...
  "urls": {
    "canonical": "https://www.data.go.kr/data/15094797/openapi.do",
    "api": "https://www.data.go.kr/data/15094797/openapi.do",
    "documentation": null
  },
  "access": {
    "method": "api",
  ...
  "search_projection": {
    ...
    "search_facets": {},
    "search_text": "source.fsc.medical-reimbursement-insurance 금융위원회 실손보험정보 source 생명보험협회 및 손해보험협회에서 제공하는 실손의료보험 유형, 담보, 성별·연령별 기준 보험료 api 후",
    "provenance_shard": "reference",
    "source_ids": []
  },
