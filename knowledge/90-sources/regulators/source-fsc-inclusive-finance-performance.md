---
{
  "id": "source.fsc.inclusive-finance-performance",
  "title": "금융위원회 서민금융지원실적정보",
  "type": "source",
  "description": "미소금융·햇살론 등 정책서민금융상품의 지원금액, 이용자 수, 지역·성별·연령대별 실적 API 후보입니다.",
  "basis_year": null,
  "parents": [],
  "children": [],
  "related": [],
  ...
  "url": "https://www.data.go.kr/data/15094801/openapi.do",
  ...
  "urls": {
    "canonical": "https://www.data.go.kr/data/15094801/openapi.do",
    "api": "https://www.data.go.kr/data/15094801/openapi.do",
    "documentation": null
  },
  "access": {
    "method": "api",
  ...
  "search_projection": {
    ...
    "search_facets": {},
    "search_text": "source.fsc.inclusive-finance-performance 금융위원회 서민금융지원실적정보 source 미소금융·햇살론 등 정책서민금융상품의 지원금액, 이용자 수, 지역·성별·연령대별 실적 api 후보입",
    "provenance_shard": "reference",
    "source_ids": []
  },
