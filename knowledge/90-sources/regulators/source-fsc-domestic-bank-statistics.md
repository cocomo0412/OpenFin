---
{
  "id": "source.fsc.domestic-bank-statistics",
  "title": "금융위원회 금융통계국내은행정보",
  "type": "source",
  "description": "국내은행 일반현황, 재무현황, 주요 경영지표, 주요 영업활동을 제공하는 공식 API 후보입니다.",
  "basis_year": null,
  "parents": [],
  "children": [],
  "related": [],
  ...
  "urls": {
    "canonical": "https://www.data.go.kr/data/15061304/openapi.do",
    "api": "https://www.data.go.kr/data/15061304/openapi.do",
    "documentation": null
  },
  "access": {
    "method": "api",
  ...
  "search_projection": {
    ...
    "search_facets": {},
    "search_text": "source.fsc.domestic-bank-statistics 금융위원회 금융통계국내은행정보 source 국내은행 일반현황, 재무현황, 주요 경영지표, 주요 영업활동을 제공하는 공식 api 후보입니다. https:",
    "provenance_shard": "reference",
    "source_ids": []
  },
