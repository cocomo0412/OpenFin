---
{
  "id": "source.fsc.financial-company-credit",
  "title": "금융위원회 금융회사재무신용정보",
  "type": "source",
  "description": "금융회사 재무·신용 정보를 상품 제공자 리스크 축으로 연결하기 위한 공식 API 후보입니다.",
  "basis_year": null,
  "parents": [],
  "children": [],
  "related": [],
  ...
  "url": "https://www.data.go.kr/data/15059594/openapi.do",
  ...
  "urls": {
    "canonical": "https://www.data.go.kr/data/15059594/openapi.do",
    "api": "https://www.data.go.kr/data/15059594/openapi.do",
    "documentation": null
  },
  "access": {
    "method": "api",
  ...
  "search_projection": {
    ...
    "search_facets": {},
    "search_text": "source.fsc.financial-company-credit 금융위원회 금융회사재무신용정보 source 금융회사 재무·신용 정보를 상품 제공자 리스크 축으로 연결하기 위한 공식 api 후보입니다. https://",
    "provenance_shard": "reference",
    "source_ids": []
  },
