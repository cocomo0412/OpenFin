---
{
  "id": "source.fsc.financial-investment-statistics",
  "title": "금융위원회 금융투자협회종합통계정보",
  "type": "source",
  "description": "펀드 순자산, CMA 잔고, 신용공여 잔고, 증시자금 추이 등 자본시장 통계 API 후보입니다.",
  "basis_year": null,
  "parents": [],
  "children": [],
  "related": [],
  ...
  "basis_date": "2026-07-04T00:00:00.000Z",
  "source_urls": [
  ...
  "urls": {
    "canonical": "https://www.data.go.kr/data/15094809/openapi.do",
    "api": "https://www.data.go.kr/data/15094809/openapi.do",
    "documentation": null
  },
  "access": {
    "method": "api",
  ...
  "search_projection": {
    ...
    "search_facets": {},
    "search_text": "source.fsc.financial-investment-statistics 금융위원회 금융투자협회종합통계정보 source 펀드 순자산, cma 잔고, 신용공여 잔고, 증시자금 추이 등 자본시장 통계 api 후보입니",
    "provenance_shard": "reference",
    "source_ids": []
  },
