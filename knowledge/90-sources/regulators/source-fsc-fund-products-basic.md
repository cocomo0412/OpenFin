---
{
  "id": "source.fsc.fund-products-basic",
  "title": "금융위원회 펀드상품기본정보",
  "type": "source",
  "description": "금융투자협회 펀드표준코드 기반의 펀드 명칭, 코드, 운용사, 펀드유형 정보를 제공하는 공식 API 후보입니다.",
  "basis_year": null,
  "parents": [],
  "children": [],
  "related": [],
  ...
  "urls": {
    "canonical": "https://www.data.go.kr/data/15094792/openapi.do",
    "api": "https://www.data.go.kr/data/15094792/openapi.do",
    "documentation": null
  },
  "access": {
    "method": "api",
  ...
  "search_projection": {
    ...
    "search_facets": {},
    "search_text": "source.fsc.fund-products-basic 금융위원회 펀드상품기본정보 source 금융투자협회 펀드표준코드 기반의 펀드 명칭, 코드, 운용사, 펀드유형 정보를 제공하는 공식 api 후보입니다. https",
    "provenance_shard": "reference",
    "source_ids": []
  },
