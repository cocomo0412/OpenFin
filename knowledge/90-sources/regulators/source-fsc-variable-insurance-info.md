---
{
  "id": "source.fsc.variable-insurance-info",
  "title": "금융위원회 변액보험기본정보",
  "type": "source",
  "description": "생명보험협회 변액보험 펀드별 기준가, 순자산, 설정일자, 운용회사 정보를 제공하는 API 후보입니다.",
  "basis_year": null,
  "parents": [],
  "children": [],
  "related": [],
  ...
  "url": "https://www.data.go.kr/data/15094793/openapi.do",
  ...
  "urls": {
    "canonical": "https://www.data.go.kr/data/15094793/openapi.do",
    "api": "https://www.data.go.kr/data/15094793/openapi.do",
    "documentation": null
  },
  "access": {
    "method": "api",
  ...
  "search_projection": {
    ...
    "search_facets": {},
    "search_text": "source.fsc.variable-insurance-info 금융위원회 변액보험기본정보 source 생명보험협회 변액보험 펀드별 기준가, 순자산, 설정일자, 운용회사 정보를 제공하는 api 후보입니다. https:",
    "provenance_shard": "reference",
    "source_ids": []
  },
