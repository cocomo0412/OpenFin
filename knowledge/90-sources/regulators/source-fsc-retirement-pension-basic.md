---
{
  "id": "source.fsc.retirement-pension-basic",
  "title": "금융위원회 퇴직연금기본정보",
  "type": "source",
  "description": "퇴직연금 상품·운용 관련 기본정보를 투자상품 축으로 연결하기 위한 공식 API 후보입니다.",
  "basis_year": null,
  "parents": [],
  "children": [],
  "related": [],
  ...
  "url": "https://www.data.go.kr/data/15094798/openapi.do",
  ...
  "publisher": "금융위원회",
  "authority_class": "regulator_official",
  "domains": [
    "finance-reference",
    "pension"
  ],
  "urls": {
    "canonical": "https://www.data.go.kr/data/15094798/openapi.do",
    "api": "https://www.data.go.kr/data/15094798/openapi.do",
    "documentation": null
  },
  "access": {
    "method": "api",
  ...
  "publication_memberships": [
    ...
    "korea-pension-products-ontology-2026.json"
  ],
  "search_projection": {
    "id": "source.fsc.retirement-pension-basic",
    "title": "금융위원회 퇴직연금기본정보",
    ...
    "search_aliases": [],
    "aliases": [],
    "export_id": "pension-products-ontology",
    ...
    "search_facets": {},
    "search_text": "source.fsc.retirement-pension-basic 금융위원회 퇴직연금기본정보 source 퇴직연금 상품·운용 관련 기본정보를 투자상품 축으로 연결하기 위한 공식 api 후보입니다. https://www",
    "provenance_shard": "reference",
    "source_ids": []
  },
