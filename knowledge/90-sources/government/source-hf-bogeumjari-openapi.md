---
{
  "id": "source.hf.bogeumjari-openapi",
  "title": "한국주택금융공사 u-보금자리론대출정보",
  "type": "source",
  "description": "u-보금자리론 대출정보를 정책 주택담보대출 상품의 API 후보로 보존합니다.",
  "basis_year": null,
  "parents": [],
  "children": [],
  "related": [],
  ...
  "url": "https://www.data.go.kr/data/15082039/openapi.do?recommendDataYn=Y",
  ...
  "urls": {
    "canonical": "https://www.data.go.kr/data/15082039/openapi.do?recommendDataYn=Y",
    "api": "https://www.data.go.kr/data/15082039/openapi.do?recommendDataYn=Y",
    "documentation": null
  },
  "access": {
    "method": "api",
  ...
  "search_projection": {
    ...
    "search_facets": {},
    "search_text": "source.hf.bogeumjari-openapi 한국주택금융공사 u-보금자리론대출정보 source u-보금자리론 대출정보를 정책 주택담보대출 상품의 api 후보로 보존합니다. https://www.data.go.",
    "provenance_shard": "reference",
    "source_ids": []
  },
