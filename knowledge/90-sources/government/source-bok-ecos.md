...
{
  "id": "source.bok.ecos",
  "title": "한국은행 ECOS Open API",
  "type": "source",
  "description": "기준금리, 시장금리, 환율 등 금융상품 비교에 필요한 기준 지표를 제공하는 한국은행 경제통계 Open API입니다.",
  "basis_year": null,
  "parents": [],
  "children": [],
  "related": [],
  ...
  "urls": {
    "canonical": "https://ecos.bok.or.kr/api/",
  ...
  "search_projection": {
    ...
    "search_facets": {},
    "search_text": "source.bok.ecos 한국은행 ecos open api source 기준금리, 시장금리, 환율 등 금융상품 비교에 필요한 기준 지표를 제공하는 한국은행 경제통계 open api입니다. https://ecos.",
    "provenance_shard": "reference",
    "source_ids": []
  },
