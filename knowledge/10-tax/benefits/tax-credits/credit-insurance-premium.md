---
{
  ...
  "criteria": [
    {
      "label": "보장성보험료",
      "condition": "일용근로자를 제외한 근로소득자가 기본공제대상자를 피보험자로 하는 법정 보장성보험료를 납입하면 연 100만원 한도로 12%를 공제합니다. 만기환급금이 납입보험료를 초과하지 않는 보험이어야 합니다.",
      "basis": "공식 공시 원문",
    ...
    {
      "label": "장애인전용 보험료",
      "condition": "기본공제대상 장애인을 피보험자 또는 수익자로 하는 법정 장애인전용 보장성보험료는 별도로 연 100만원 한도로 15%를 공제합니다.",
      "basis": "공식 공시 원문",
      "source": "source.law.income-tax-act.deductions-credits",
      "criteria_kind": "disclosure"
    }
  ...
  "provenance": [
    {
      ...
      "source_record_id": "credit.insurance-premium",
      "collected_at": "2026-09-23T08:26:20.830416+00:00",
      "reviewed_at": "2026-09-23T08:26:20.830416+00:00",
      ...
      "locator": {
        "kind": "record-id",
        "value": "credit.insurance-premium"
      }
    }
  ],
  "search_projection": {
